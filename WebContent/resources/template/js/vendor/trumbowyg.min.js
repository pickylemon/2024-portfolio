    ...
    (function (e, t, n, a) {
        ...
        var o = function (o, r) {
            ...
            (i.doc = o.ownerDocument || n),
                ...
                (i.$c = a(o)),
                (r = r || {}),
                null != r.lang || null != a.trumbowyg.langs[r.lang]
                    ? (i.lang = a.extend(
                          !0,
                          {},
                          a.trumbowyg.langs.en,
                          a.trumbowyg.langs[r.lang]
                      ))
                    : (i.lang = a.trumbowyg.langs.en),
                (i.hideButtonTexts =
                    null != a.trumbowyg.hideButtonTexts
                        ? a.trumbowyg.hideButtonTexts
                        : r.hideButtonTexts);
            var l =
                null != a.trumbowyg.svgPath ? a.trumbowyg.svgPath : r.svgPath;
            if (
                ((i.hasSvg = l !== !1),
                ...
                (g.id = s),
                    ...
                    a.ajax({
                        ...
                        complete: null,
                        success: function (e) {
                            g.innerHTML = new XMLSerializer().serializeToString(
                                e.documentElement
                            );
                        },
                    });
            ...
            var f = i.lang.header,
                h = function () {
                    return (
                        (t.chrome || (t.Intl && Intl.v8BreakIterator)) &&
                        "CSS" in t
                    );
                };
            (i.btnsDef = {
                ...
                r.btns
                    ? (i.o.btns = r.btns)
                    : i.o.semantic || (i.o.btns[4] = "btnGrp-design"),
        ...
        o.prototype = {
            ...
            buildEditor: function () {
                ...
                (e.$box = a("<div/>", {
                    ...
                    e.semanticCode(),
                    e.o.autogrowOnEnter && e.$ed.addClass("autogrow-on-enter");
                var r,
                    i = !1,
                    s = !1,
                            ...
                            (!t.ctrlKey || (89 !== n && 90 !== n)
                                ? i || 17 === n
                                    ? "undefined" == typeof t.which &&
                                      e.semanticCode(!1, !1, !0)
                                    : (e.semanticCode(!1, 13 === n),
            ...
            toggle: function () {
                var e = this,
                    t = e.o.prefix;
                e.o.autogrowOnEnter &&
                    (e.autogrowOnEnterDontClose = !e.$box.hasClass(
                        t + "editor-hidden"
                    )),
                    e.semanticCode(!1, !0),
                    setTimeout(function () {
            ...
            syncTextarea: function () {
                ...
                e.$ta.val(
                    e.$ed.text().trim().length > 0 ||
                        e.$ed.find("hr,img,embed,iframe,input").length > 0
                        ? e.$ed.html()
                        : ""
                );
            },
            ...
            openModal: function (e, n) {
                ...
                o.o.autogrowOnEnter && (o.autogrowOnEnterDontClose = !0),
                    o.saveRange(),
                    o.showOverlay(),
                    o.$overlay.css({ height: o.$ed.outerHeight() + 1 + "px" }),
            ...
            addErrorOnModalField: function (e, t) {
                ...
                e.on("change keyup", function () {
                    ...
                    o
                        ...
                        .find("input+span")
                        .append(
                            a("<span/>", { class: n + "msg-error", text: t })
                        );
            },
            saveRange: function () {
                var e = this,
