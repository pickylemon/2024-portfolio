...
public class BoardCommentService {
	...
	@Transactional
	public List<CommentResultDto> getCommentList(int boardSeq, int boardTypeSeq, int memberSeq){
		List<CommentResultDto> commentDtoList = boardCommentRepository.getAllCommentList(boardSeq, boardTypeSeq);
		for(CommentResultDto commentDto : commentDtoList) {
			try {
